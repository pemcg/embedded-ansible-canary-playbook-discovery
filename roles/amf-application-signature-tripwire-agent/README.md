# amf-application-signature-tripwire-agent
An Ansible Role that identifies an Tripwire Agent server as part of the Ansible Migration Factory Discovery process.
