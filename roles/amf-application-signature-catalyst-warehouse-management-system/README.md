# amf-application-signature-catalyst-warehouse-management-system
An Ansible Role that identifies an Catalyst Warehouse Management System server as part of the Ansible Migration Factory Discovery process.
