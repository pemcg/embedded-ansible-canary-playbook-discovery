# amf-application-signature-oracle-enterprise-manager
An Ansible Role that identifies an Oracle Enterprise Manager server as part of the Ansible Migration Factory Discovery process.
