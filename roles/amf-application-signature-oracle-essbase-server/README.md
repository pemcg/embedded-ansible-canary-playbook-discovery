# amf-application-signature-oracle-essbase-server
An Ansible Role that identifies an Oracle ESSBASE server as part of the Ansible Migration Factory Discovery process.
