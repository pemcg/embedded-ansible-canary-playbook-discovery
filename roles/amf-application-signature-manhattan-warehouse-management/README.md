# amf-application-signature-manhattan-warehouse-management
An Ansible Role that identifies an Manhattan Warehouse Management server as part of the Ansible Migration Factory Discovery process.
