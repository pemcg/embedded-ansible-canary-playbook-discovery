# amf-application-signature-tsm-backup-archive-client
An Ansible Role that identifies an TSM Backup-Archive Client server as part of the Ansible Migration Factory Discovery process.
