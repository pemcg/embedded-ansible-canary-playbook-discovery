# amf-application-signature-oracle-weblogic-server
An Ansible Role that identifies an Oracle Weblogic server as part of the Ansible Migration Factory Discovery process.
