# amf-application-signature-ca-workload-automation-agent
An Ansible Role that identifies an CA Workload Automation Agent server as part of the Ansible Migration Factory Discovery process.
