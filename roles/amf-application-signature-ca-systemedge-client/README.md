# amf-application-signature-ca-systemedge-client
An Ansible Role that identifies an CA SystemEdge Client server as part of the Ansible Migration Factory Discovery process.
