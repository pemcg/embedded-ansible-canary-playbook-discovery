# amf-application-signature-quest-authentication-services
An Ansible Role that identifies an Quest Authentication Services server as part of the Ansible Migration Factory Discovery process.
