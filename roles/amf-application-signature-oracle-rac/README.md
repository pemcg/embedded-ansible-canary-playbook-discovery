# amf-application-signature-oracle-rac
An Ansible Role that identifies an Oracle Real Application Clusters server as part of the Ansible Migration Factory Discovery process.
