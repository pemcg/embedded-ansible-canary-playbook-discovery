# amf-application-signature-jboss-application-server
An Ansible Role that identifies an JBoss Application Server server as part of the Ansible Migration Factory Discovery process.
