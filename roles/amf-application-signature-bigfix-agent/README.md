# amf-application-signature-bigfix-agent
An Ansible Role that identifies an BigFix Agent server as part of the Ansible Migration Factory Discovery process.
