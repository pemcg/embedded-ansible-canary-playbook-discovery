# amf-application-signature-sas-intelligent-planning-suite
An Ansible Role that identifies an SAS Intelligent Planning Suite server as part of the Ansible Migration Factory Discovery process.
