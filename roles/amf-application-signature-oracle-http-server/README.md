# amf-application-signature-oracle-http-server
An Ansible Role that identifies an Oracle HTTP server as part of the Ansible Migration Factory Discovery process.
