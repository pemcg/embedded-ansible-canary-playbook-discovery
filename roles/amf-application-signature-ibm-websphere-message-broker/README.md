# amf-application-signature-ibm-websphere-message-broker
An Ansible Role that identifies an IBM Websphere Message Broker server as part of the Ansible Migration Factory Discovery process.
