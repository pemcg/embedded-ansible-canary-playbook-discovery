# amf-application-signature-ibm-websphere-mq-file-transfer-edition
An Ansible Role that identifies an IBM WebSphere MQ File Transfer Edition server as part of the Ansible Migration Factory Discovery process.
