# amf-application-signature-lpar2rrd-agent
An Ansible Role that identifies an LPAR2RRD Agent server as part of the Ansible Migration Factory Discovery process.
